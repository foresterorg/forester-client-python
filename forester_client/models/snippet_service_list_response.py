...
class SnippetServiceListResponse(BaseModel):
    """
    SnippetServiceListResponse
    """ # noqa: E501
    snippets: Optional[List[Dict[str, Any]]] = Field(default=None, description="[]Snippet")
    __properties: ClassVar[List[str]] = ["snippets"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "snippets": [Snippet.from_dict(_item) for _item in obj.get("snippets")] if obj.get("snippets") is not None else None
        })
        return _obj
