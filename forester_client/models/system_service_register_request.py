...
class SystemServiceRegisterRequest(BaseModel):
    """
    SystemServiceRegisterRequest
    """ # noqa: E501
    system: Optional[NewSystem] = None
    __properties: ClassVar[List[str]] = ["system"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "system": NewSystem.from_dict(obj.get("system")) if obj.get("system") is not None else None
        })
        return _obj
